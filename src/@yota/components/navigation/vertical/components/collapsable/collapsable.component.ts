...
@Component({
    selector       : 'yota-vertical-navigation-collapsable-item',
    templateUrl    : './collapsable.component.html',
    animations     : yotaAnimations,
    changeDetection: ChangeDetectionStrategy.OnPush,
    standalone     : true,
    imports        : [NgClass, MatTooltipModule, NgIf, MatIconModule, NgFor, YotaVerticalNavigationBasicItemComponent, forwardRef(() => YotaVerticalNavigationCollapsableItemComponent), YotaVerticalNavigationDividerItemComponent, YotaVerticalNavigationGroupItemComponent, YotaVerticalNavigationSpacerItemComponent],
})
export class YotaVerticalNavigationCollapsableItemComponent implements OnInit, OnDestroy
{
    ...
    @HostBinding('class') get classList(): any
    {
        /* eslint-disable @typescript-eslint/naming-convention */
        return {
            'yota-vertical-navigation-item-collapsed': this.isCollapsed,
            'yota-vertical-navigation-item-expanded' : this.isExpanded,
        };
        /* eslint-enable @typescript-eslint/naming-convention */
    }
    ...
    ngOnInit(): void
    {
        ...
        this._yotaVerticalNavigationComponent.onCollapsableItemCollapsed
        ...
        if ( this.autoCollapse )
        {
            this._yotaVerticalNavigationComponent.onCollapsableItemExpanded
                .pipe(takeUntil(this._unsubscribeAll))
    ...
    collapse(): void
    {
        ...
        this._yotaVerticalNavigationComponent.onCollapsableItemCollapsed.next(this.item);
    }
    ...
    expand(): void
    {
        ...
        // Execute the observable
        this._yotaVerticalNavigationComponent.onCollapsableItemExpanded.next(this.item);
    }
     ...
     * @private
     */
    private _isChildrenOf(parent: YotaNavigationItem, item: YotaNavigationItem): boolean
    {
