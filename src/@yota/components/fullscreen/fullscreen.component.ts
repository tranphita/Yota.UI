...
import { FSDocument, FSDocumentElement } from '@yota/components/fullscreen/fullscreen.types';

@Component({
    selector       : 'yota-fullscreen',
    templateUrl    : './fullscreen.component.html',
    encapsulation  : ViewEncapsulation.None,
    changeDetection: ChangeDetectionStrategy.OnPush,
    exportAs       : 'yotaFullscreen',
    standalone     : true,
    imports        : [MatButtonModule, MatTooltipModule, NgTemplateOutlet, MatIconModule],
})
export class YotaFullscreenComponent implements OnInit
{
