...
@Component({
    selector     : 'yota-masonry',
    templateUrl  : './masonry.component.html',
    encapsulation: ViewEncapsulation.None,
    animations   : yotaAnimations,
    exportAs     : 'yotaMasonry',
    standalone   : true,
    imports      : [NgTemplateOutlet],
})
export class YotaMasonryComponent implements OnChanges, AfterViewInit
{
     ...
     * Constructor
     */
    constructor(private _yotaMediaWatcherService: YotaMediaWatcherService)
    {
    }
