...
import { YotaHighlightService } from '@yota/components/highlight/highlight.service';

@Component({
    selector       : 'textarea[yota-highlight]',
    templateUrl    : './highlight.component.html',
    styleUrls      : ['./highlight.component.scss'],
    encapsulation  : ViewEncapsulation.None,
    changeDetection: ChangeDetectionStrategy.OnPush,
    exportAs       : 'yotaHighlight',
    standalone     : true,
    imports        : [NgClass],
})
export class YotaHighlightComponent implements OnChanges, AfterViewInit
{
    @Input() code: string;
    @Input() lang: string;
    ...
    constructor(
        ...
        private _yotaHighlightService: YotaHighlightService,
    ...
    private _highlightAndInsert(): void
    {
        ...
        this.highlightedCode = this._domSanitizer.sanitize(SecurityContext.HTML, this._yotaHighlightService.highlight(this.code, this.lang));
