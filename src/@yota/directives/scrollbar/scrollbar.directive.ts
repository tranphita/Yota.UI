...
import { ScrollbarGeometry, ScrollbarPosition } from '@yota/directives/scrollbar/scrollbar.types';
 ...
 */
@Directive({
    selector  : '[yotaScrollbar]',
    exportAs  : 'yotaScrollbar',
    standalone: true,
})
export class YotaScrollbarDirective implements OnChanges, OnInit, OnDestroy
{
    /* eslint-disable @typescript-eslint/naming-convention */
    static ngAcceptInputType_yotaScrollbar: BooleanInput;
    /* eslint-enable @typescript-eslint/naming-convention */

    @Input() yotaScrollbar: boolean = true;
    @Input() yotaScrollbarOptions: PerfectScrollbar.Options;
    ...
    {
        // Enabled
        if ( 'yotaScrollbar' in changes )
        {
            // Interpret empty string as 'true'
            this.yotaScrollbar = coerceBooleanProperty(changes.yotaScrollbar.currentValue);

            // If enabled, init the directive
            if ( this.yotaScrollbar )
            {
                this._init();
            }
        ...
        // Scrollbar options
        if ( 'yotaScrollbarOptions' in changes )
        {
            // Merge the options
            this._options = merge({}, this._options, changes.yotaScrollbarOptions.currentValue);
