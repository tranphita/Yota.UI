...
import { YotaMockApiReplyCallback } from '@yota/lib/mock-api/mock-api.types';
import { Observable, of, take, throwError } from 'rxjs';

export class YotaMockApiHandler
{
    request!: HttpRequest<any>;
    urlParams!: { [key: string]: string };

    // Private
    private _reply: YotaMockApiReplyCallback = undefined;
     ...
     * @param callback
     */
    reply(callback: YotaMockApiReplyCallback): void
    {
        // Store the reply
