...
import { YotaMockApiService, YotaMockApiUtils } from '@yota/lib/mock-api';
    ...
    registerHandlers(): void
    {
        ...
        this._yotaMockApiService
            ...
            .reply(({request}) =>
            {
                ...
                // Generate a new GUID
                newList.id = YotaMockApiUtils.guid();
        ...
        this._yotaMockApiService
            ...
            .reply(({request}) =>
            {
                ...
                // Generate a new GUID
                newCard.id = YotaMockApiUtils.guid();
        ...
        this._yotaMockApiService
            ...
            .reply(({request}) =>
            {
                ...
                // Generate a new GUID
                newLabel.id = YotaMockApiUtils.guid();
