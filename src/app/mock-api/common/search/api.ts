...
import { YotaNavigationItem, YotaNavigationService } from '@yota/components/navigation';
...
{
    private readonly _defaultNavigation: YotaNavigationItem[] = defaultNavigation;
     ...
     */
    constructor(
        private _yotaMockApiService: YotaMockApiService,
    ...
    registerHandlers(): void
    {
        ...
        const flatNavigation = this._yotaNavigationService.getFlatNavigation(this._defaultNavigation);
