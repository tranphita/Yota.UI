...
export class LayoutComponent implements OnInit, OnDestroy
{
    ...
    constructor(
        ...
        private _yotaConfigService: YotaConfigService,
        private _yotaMediaWatcherService: YotaMediaWatcherService,
        private _yotaPlatformService: YotaPlatformService,
    )
    {
    }
    ...
    ngOnInit(): void
    {
        ...
        combineLatest([
            this._yotaConfigService.config$,
            this._yotaMediaWatcherService.onMediaQueryChange$(['(prefers-color-scheme: dark)', '(prefers-color-scheme: light)']),
        ]).pipe(
        ...
        // Set the app version
        this._renderer2.setAttribute(this._document.querySelector('[ng-version]'), 'yota-version', YOTA_VERSION);

        // Set the OS name
        this._renderer2.addClass(this._document.body, this._yotaPlatformService.osName);
    }
